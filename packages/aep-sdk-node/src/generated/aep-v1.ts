...
export interface paths {
    ...
    "/aep/v1/admin/users/{userId}/rbac": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put: operations["replaceUserRBAC"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/aep/v1/admin/agents/{agentId}/profile": {
        ...
        get?: never;
        /** @description Requires the agents.write or users.write permission (or a full administrator). Updates the digital employee profile. Every field is optional; a null value clears the stored field. Changing homeTeamId requires the same team grant rights as creation. Problem codes: 400 INVALID_AGENT; 404 RESOURCE_NOT_FOUND. */
...
export interface operations {
    ...
    replaceUserRBAC: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ReplaceUserRBACRequest"];
            };
        };
        responses: {
            /** @description User role and Team bindings */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["UserRBAC"];
                };
            };
            400: components["responses"]["Problem"];
            403: components["responses"]["Problem"];
